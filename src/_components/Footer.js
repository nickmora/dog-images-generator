    ...
    return (
        <div className = {classes.Footer}>
            <Typography variant = "body2" justify = "center" >
                ...
                <br />
                This app was built by Nick Morales, check out the <a rel = "noopener noreferrer" target = "_blank" href = "https://github.com/nickmora/dog-images-generator"> source code here</a>
                <br />
